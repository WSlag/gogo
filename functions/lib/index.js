...
exports.paymongoWebhook = exports.verifyEWalletPayment = exports.checkPaymentStatus = exports.processOrderPayment = exports.processRidePayment = exports.createPaymentSource = exports.createPaymentIntent = exports.cleanupNotifications = exports.validatePromo = exports.processTopUp = exports.onOrderUpdated = exports.onOrderCreated = exports.onRideUpdated = exports.onRideCreated = exports.onMerchantCreated = exports.onDriverCreated = exports.setUserRole = exports.onUserCreate = exports.bootstrapAdmin = void 0;
...
exports.bootstrapAdmin = functions.https.onCall(async (_data, context) => {
    ...
    if (userData?.role !== 'admin') {
        throw new functions.https.HttpsError('permission-denied', 'You do not have admin role in Firestore. Set role to admin in Firestore first.');
    }
...
exports.onDriverCreated = functions.firestore
...
async function handleRideCompleted(rideId, ride) {
...
exports.validatePromo = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
...
exports.createPaymentSource = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
...
exports.processRidePayment = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
...
exports.checkPaymentStatus = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const response = await paymongoRequest(endpoint, 'GET');
...
exports.verifyEWalletPayment = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    const { sourceId } = data;
    ...
    try {
        ...
        const response = await paymongoRequest(`/sources/${sourceId}`, 'GET');
