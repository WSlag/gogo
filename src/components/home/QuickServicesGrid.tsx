...
export function QuickServicesGrid({
  ...
  return (
    <section className={cn('', className)}>
      {showHeader && (
        <h2 className="text-base font-bold text-gray-900 mb-5">Quick Services</h2>
      )}
        ...
        {services.map((service) => {
          ...
          return (
            <button
              ...
              className="flex flex-col items-center gap-3 py-4 px-3 rounded-xl hover:bg-gray-50 active:scale-95 transition-all group"
            >
